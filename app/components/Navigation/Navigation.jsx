        ...
        <Styled.NavLinks className="container">
          ...
          <Styled.Nav>
            ...
            <Styled.IconBox>
              ...
              <div
                className="iconBox"
                onClick={() => window.open("tel:6668880000")}
              >
            ...
            <Styled.NavWidth>
              <Styled.Nav>
                ...
                <Styled.NavItem>
                  <Styled.NavLink href="#">Resurses</Styled.NavLink>
                  <Styled.DropdownMenu>
                    {/* <Styled.DropdownItem className="dropdown">
                    <Styled.NavLink href="aboutPage">About </Styled.NavLink>
                  </Styled.DropdownItem> */}
      ...
      {open ? (
        <>
          ...
          <Styled.MainContainer>
            ...
            <a className="heading" href="aboutPage">
              About
            </a>
            <hr />
            <a className="heading" href="#">
            ...
            <hr />
            <a className="heading" href="events">
              Event
            </a>
            <hr />
            {/* <ul>
            ...
            <a className="heading" href="contact">
              Contact
            </a>{" "}
            <hr />
            ...
            <Styled.BtnCenter>
              <Styled.BtnDarkMedia href="contact">Contact</Styled.BtnDarkMedia>
            </Styled.BtnCenter>
          </Styled.MainContainer>
        </>
      ) : (
